...
description: >-
  ...
  Vitest 主戦場 @openpbx/core、legacy 読取専用、契約 ID は docs/TDD-REBUILD-PLAN.md。
  Use when: /denwa, denwa, OpenPBX rebuild, pbx-core, TDD-REBUILD-PLAN, npm run harness,
  test:gate, legacy, golden master, Phase 0〜10, preToolUse, postToolUse, Cursor hooks.
